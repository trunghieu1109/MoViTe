...
def get_current_state():
    r = requests.get("http://localhost:8933/LGSVL/Status/CenterCamera")
...
def get_action_space():
    ...
    # json_file = open('../../RESTfulAPIProcess/RESTful_API.json', 'r')
    # json_file = open('../../RESTfulAPIProcess/RESTful_API_customized.json', 'r')
    json_file = open('../../RESTfulAPIProcess/RESTful_API_new_action.json', 'r')
