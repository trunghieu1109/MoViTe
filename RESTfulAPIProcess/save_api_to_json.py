...
RESTful_API = {
    "command": {
        'num': 22,
        '0': "http://localhost:8933/LGSVL/LoadNPCVehicleRandomly",
        '1': "http://localhost:8933/LGSVL/LoadPedestriansRandomly",
        '2': "http://localhost:8933/LGSVL/Control/Weather/Nice",
        '3': "http://localhost:8933/LGSVL/Control/Weather/Rain?rain_level=Light",
        '4': "http://localhost:8933/LGSVL/Control/Weather/Rain?rain_level=Moderate",
        '5': "http://localhost:8933/LGSVL/Control/Weather/Rain?rain_level=Heavy",
        '6': "http://localhost:8933/LGSVL/Control/Weather/Fog?fog_level=Light",
        '7': "http://localhost:8933/LGSVL/Control/Weather/Fog?fog_level=Moderate",
        '8': "http://localhost:8933/LGSVL/Control/Weather/Fog?fog_level=Heavy",
        '9': "http://localhost:8933/LGSVL/Control/Weather/Wetness?wetness_level=Light",
        '10': "http://localhost:8933/LGSVL/Control/Weather/Wetness?wetness_level=Moderate",
        '11': "http://localhost:8933/LGSVL/Control/Weather/Wetness?wetness_level=Heavy",
        '12': "http://localhost:8933/LGSVL/Control/TimeOfDay?time_of_day=Morning",
        '13': "http://localhost:8933/LGSVL/Control/TimeOfDay?time_of_day=Noon",
        '14': "http://localhost:8933/LGSVL/Control/TimeOfDay?time_of_day=Evening",
        '15': "http://localhost:8933/LGSVL/Control/Agents/NPCVehicle/AddNPCVehicle?which_lane=Left_Lane",
        '16': "http://localhost:8933/LGSVL/Control/Agents/NPCVehicle/AddNPCVehicle?which_lane=Right_Lane",
        '17': "http://localhost:8933/LGSVL/Control/Agents/NPCVehicle/AddNPCVehicle?which_lane=Current_Lane",
        '18': "http://localhost:8933/LGSVL/Control/Agents/NPCVehicle/NPCVehicleSwitchLane",
        '19': "http://localhost:8933/LGSVL/Control/Agents/Pedestrians/WalkRandomly?which_lane=Left_Lane",
        '20': "http://localhost:8933/LGSVL/Control/Agents/Pedestrians/WalkRandomly?which_lane=Right_Lane",
        '21': "http://localhost:8933/LGSVL/Control/Agents/Pedestrians/WalkRandomly?which_lane=Current_Lane"
    },
    "status": {
        'num': 4,
        '0': "http://localhost:8933/LGSVL/Status/CollisionInfo",
        '1': "http://localhost:8933/LGSVL/Status/EGOVehicle/Speed",
        '2': "http://localhost:8933/LGSVL/Status/EGOVehicle/Position",
        '3': "http://localhost:8933/LGSVL/Status/GPSData"
