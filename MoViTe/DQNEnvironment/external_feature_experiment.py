...
def get_environment_state():
    ...
    state[0] = a['weather'] # external
    state[1] = a['timeofday'] # external
    state[2] = a['signal'] # external
    
    # add advanced external states 
    state[3] = a['num_obs'] # external
    state[4] = a['min_obs_dist'] # external
    state[5] = a['speed_min_obs_dist'] # external
...
if __name__ == '__main__':
    ...
    folder_name = './model/external_feature_sanfrancisco_road3_standard/'
    ...
    if reuse_mem_eps != '':
        ...
        for i in range(old_memory.real_size):
            ...
            new_state_ = state_[3:6] + state_[10:13]
            new_next_state_ = next_state_[3:6] + next_state_[10:13]
