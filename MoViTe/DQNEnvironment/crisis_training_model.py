...
def get_environment_state():
    ...
    a = r.json()
    state = np.zeros(23)
    state[0] = a['left_boundary_type']
    state[1] = a['right_boundary_type']   # check if exist left / right lane or ego is on a junction
    state[2] = a['weather']
    state[3] = a['timeofday']
    state[4] = a['signal']
    state[5] = a['rx']
...
if __name__ == '__main__':
    ...
    folder_name = './model/crisis_standard_sanfrancisco_road3/'
