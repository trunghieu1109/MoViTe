...
for loop in range(0, 5):
    ...
    folder_name = 'short_paper_borregasave_road1'
    ...
    while True:
        ...
        while(retry):
            ...
            try:
                ...
                _, _, probability, DTO, ETTC, done, collision_probability_per_step, DTO_list, ETTC_list, collision_uid, = calculate_reward(action)
        ...
        print('api_id, probability, DTO, ETTC, done: ', action, probability, DTO, ETTC, done)
            ...
            if len(state_) <= 5:
                if not isCollision:
                    ...
                    for iter in range(0, len(state_)):
                        pd.DataFrame([[iteration, state_[iter], action_[iter], type_[iter], probability_[iter], DTO_[iter], ETTC_[iter], collision_uid_[iter], 
                                        collision_probability_per_step_[iter], DTO_list_[iter], ETTC_list_[iter], done_[iter]]]).to_csv(
