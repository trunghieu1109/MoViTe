...
APOLLO_HOST = '171.248.242.202'  # or 'localhost'
PORT = 23034
DREAMVIEW_PORT = 23159
BRIDGE_PORT = 23389

#  171.248.46.71:23994 -> 22/tcp
# 171.248.46.71:23081 -> 5900/tcp
# 171.248.46.71:23059 -> 5901/tcp
# 171.248.46.71:23734 -> 8888/tcp
# 171.248.46.71:23918 -> 8966/tcp
# 171.248.46.71:23941 -> 9090/tcp 
...
def get_environment_state():
    ...
    state_dict = {'x': position.x, 'y': position.y, 'z': position.z,
                  ...
                  'left_boundary_type': current_lane['left_boundary_type'],
                  'right_boundary_type': current_lane['right_boundary_type']
                  }
